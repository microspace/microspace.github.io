...
<div id="game">
	<div class="main">
		<img class="left" src="img/animal1.png" />  
		
		<div class="undertable">
		</div>

		<img class="right" src="img/animal2.png" />  
		
	</div>
	<div class="gamebuttons">
	
		<button class="button-secondary button-xlarge pure-button" onclick="fsm.restartLevel()"><i class="fas fa-undo"></i> РЕСТАРТ</button>
		<button class="button-secondary button-xlarge pure-button" onclick="fsm.playNewGame()"><i class="fas fa-sliders-h"></i> В МЕНЮ</button>
...
if (next === true) {
	...
	let main = document.querySelector('.undertable');
	let counter = 0;
	let counterBtn = true;
